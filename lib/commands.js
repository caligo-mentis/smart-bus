...
module.exports = {
    ...
    encode: function(data) {
      ...
      for (var i = 0; i < bytes; i++) {
        ...
        for (var n = 0; n < 8 && i + n < length; n++)
          if (channels[i + n].state) byte |= 1 << n;
    ...
    encode: function(data) {
      ...
      for (var j = 0; j < bytes; j++) {
        ...
        for (var n = 0; n < 8 && j + n < length; n++)
          if (channels[j + n].state) byte |= 1 << n;
  ...
  0x0009: {
    ...
    encode: function(data) {
      ...
      state.encode(buffer, data.success, 0);
  ...
  0x0032: {
    ...
    encode: function(data) {
      ...
      buffer.writeUInt8(data.channel, 0);
      state.encode(buffer, data.success, 1);
  ...
  0xF116: {
    parse: function(buffer) {
      return {
        ...
        state: Boolean(buffer.readUInt8(1))
      };
    },

    encode: function(data) {
      return new Buffer([data.block, data.state ? 1 : 0]);
    }
  },
  ...
  0xDA03: {
    parse: function(buffer) {
      return { success: state.parse(buffer, 0) };
    },
  ...
  0xE01C: {
    parse: function(data) {
      return {
        ...
        state: Boolean(data.readUInt8(1))
      };
    },
    ...
    encode: function(data) {
      ...
      buffer.writeUInt8(data.state ? 255 : 0, 1);
  ...
  0xE01D: {
    ...
    encode: function(data) {
      ...
      buffer.writeUInt8(data.switch, 0);
      buffer.writeUInt8(data.state ? 1 : 0, 1);
  ...
  0xE017: {
    parse: function(buffer) {
      ...
      for (var i = 0; i < length; i++)
        data.switches[i] = {
          number: i + 1,
          state: Boolean(buffer.readUInt8(i + 1))
        };
    ...
    encode: function(data) {
      ...
      for (var i = 0; i < length; i++)
        buffer.writeUInt8(switches[i].state ? 1 : 0, i + 1);
  ...
  0xE3E0: {
    parse: function(buffer) {
      return {
        ...
        state: buffer.readUInt8(1)
      };
    },

    encode: function(data) {
      return new Buffer([data.curtain, data.state]);
    },
  ...
  0xE3E4: {
    ...
    encode: function(data) {
      ...
      for (var i = 0; i < length; i++) {
        ...
        buffer.writeUInt8(curtain.state, length + i);
      }
  ...
  0x1945: {
    parse: function(buffer) {
      return {
        state: Boolean(buffer.readUInt8(2)),
    ...
    encode: function(data) {
      ...
      buffer.writeUInt8(data.state ? 1 : 0, 2);
  ...
  0x1C5F: {
    parse: function(buffer) {
      ...
      return {
        channel: buffer.readUInt8(0),
        work: { type: work >> 4, state: Boolean(work & 0x0F) },
    ...
    encode: function(data) {
      ...
      buffer.writeUInt8(data.channel, 0);
      buffer.writeUInt8(work.type << 4 | (work.state ? 1 : 0), 1);
      ...
      buffer.writeUInt8(watering.type << 4 | (watering.state ? 1 : 0), 11);
  ...
  0xDB01: {
    parse: function(buffer) {
      ...
      for (var i = 0; i < 2; i++) contacts[i] = {
        number: i + 1,
        state: Boolean(buffer.readUInt8(i))
      };
    ...
    encode: function(data) {
      ...
      for (var i = 0; i < 2; i++)
        buffer.writeUInt8(contacts[i].state, i);
  ...
  0x1646: {
    parse: function(buffer) {
      ...
      while (offset < 9 && offset < length) contacts[contacts.length] = {
        ...
        state: Boolean(buffer.readUInt8(offset++))
      };
    ...
    encode: function(data) {
      ...
      for (var i = 0; i < contacts.length; i++)
        buffer.writeUInt8(contacts[i].state ? 1 : 0, i + offset);
  ...
  0x1647: {
    ...
    encode: function(data) {
      ...
      for (var i = 0; i < contacts.length; i++)
        buffer.writeUInt8(contacts[i].state ? 1 : 0, i + 5);
  ...
  0x1605: {
    ...
    encode: function(data) {
      ...
      for (var i = 0; i < contacts.length; i++)
        buffer.writeUInt8(contacts[i].state ? 1 : 0, i + 7);
